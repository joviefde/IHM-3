...
En este caso desarrollaremos 3 páginas para nuestro proyecto:
  1. Menu
  2. Stuff
  3. 

Además de ello podemos ver que se desarrollará para una primera versión en movil y otra en aplicación de escritorio de ordenador.
